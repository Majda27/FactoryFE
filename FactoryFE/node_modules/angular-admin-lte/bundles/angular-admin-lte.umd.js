(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/platform-browser'), require('rxjs/operators'), require('@angular/router'), require('rxjs'), require('@angular/forms'), require('@angular/common'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('angular-admin-lte', ['exports', '@angular/platform-browser', 'rxjs/operators', '@angular/router', 'rxjs', '@angular/forms', '@angular/common', '@angular/core'], factory) :
    (factory((global['angular-admin-lte'] = {}),global.ng.platformBrowser,global.rxjs.operators,global.ng.router,global.rxjs,global.ng.forms,global.ng.common,global.ng.core));
}(this, (function (exports,platformBrowser,operators,router,rxjs,forms,common,core) { 'use strict';
